...
// WORKS-BY INTENT
module.exports.worksBy = botVars.webchatController.hears(['works-by'], 'message_received', botVars.dialogflowMiddleware.hears, function(bot, message) {
    ...
    if (filterCounter > 2) {
        ...
        botFunctions.doQuery(parameters.artist, parameters.number, parameters.instruments,
            parameters.strictly, startyear, endyear, parameters.genre, "webchat", bot, message);
...
// WORKS-BY - YES INTENT
module.exports.worksByYes = botVars.webchatController.hears(['works-by - yes'], 'message_received', botVars.dialogflowMiddleware.hears, function(bot, message) {
...
// WORKS-BY - NO
module.exports.worksByNo = botVars.webchatController.hears(['works-by - no'], 'message_received', botVars.dialogflowMiddleware.hears, function(bot, message) {
    ...
    // DO THE QUERY (WITH ALL THE INFOS)
    botFunctions.doQuery(artist, number, instruments, strictly, startyear, endyear, genre, "webchat", bot, message);
...
module.exports.worksBySomething = botVars.webchatController.hears(['works-by-artist', 'works-by-instrument', 'works-by-genre', 'works-by-years'], 'message_received', botVars.dialogflowMiddleware.hears, function(bot, message) {
...
// DISCOVER ARTIST
module.exports.findArtist = botVars.webchatController.hears(['find-artist'], 'message_received', botVars.dialogflowMiddleware.hears, function(bot, message) {
    ...
    botFunctions.doQueryFindArtist(num, startdate, enddate, city, instrument, genre, "webchat", bot, message);
...
// DISCOVER ARTIST
module.exports.discoverArtist = botVars.webchatController.hears(['discover-artist'], 'message_received', botVars.dialogflowMiddleware.hears, function(bot, message) {
    ...
    if (message['nlpResponse']['result']['actionIncomplete'] == false) {
        ...
        // SEND THE BIO TO THE USER
        botFunctions.answerBio(message.entities["doremus-artist"], "webchat", bot, message);
...
// FIND-PERFORMANCE
module.exports.findPerformance = botVars.webchatController.hears(['find-performance'], 'message_received', botVars.dialogflowMiddleware.hears, function(bot, message) {
    ...
    if (message['nlpResponse']['result']['actionIncomplete'] == false) {
        ...
        // DO THE QUERY (WITH ALL THE INFOS)
        botFunctions.doQueryPerformance(num, city, startdate, enddate, "webchat", bot, message);
...
// HELLO INTENT
module.exports.hello = botVars.webchatController.hears(['hello'], 'message_received', botVars.dialogflowMiddleware.hears, function(bot, message) {
